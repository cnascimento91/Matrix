...
public class Matrix {
	 ...
	 *
	 * @param fileName
	 *            name of the file which the matrixes will be read
	 * @throws Exception
	 */
		...
		while (in.hasNext()) {
			...
			if (count < (m1R + 3) && (count >= 3)) {
				if (val.length != m1Cm2R) {
					throw new Exception(
							"The matrix is not compatible with the dimensions");
				}
	 ...
	 *
	 * @param num
	 *            string which store the values of the matrixes dimensions
	 */
